...
def summarize(path: Path) -> dict[str, Any]:
    ...
    fields = (
        ...
        "whisper_cuda_attempted",
        "whisper_cuda_failed",
        "whisper_cuda_failure_reason",
        "whisper_cuda_preflight_skipped",
        "whisper_cuda_preflight_free_mb",
        "whisper_cuda_safe_minimum_mb",
        "whisper_cpu_fallback_attempted",
        "whisper_cpu_fallback_succeeded",
        "whisper_execution_device",
        "whisper_effective_threads",
        "whisper_effective_beam_size",
        "whisper_effective_best_of",
        "whisper_model_path",
        "whisper_model_size_mb",
        "whisper_model_quantization",
        "cpu_fallback_seconds",
        "cpu_fallback_timeout",
        "cpu_fallback_candidate_count",
        "gpu_used_mb_before_qwen",
        "gpu_used_mb_after_qwen",
        "gpu_used_mb_after_qwen_cleanup",
        "gpu_used_mb_before_whisper",
        "gpu_used_mb_after_whisper",
        "gpu_used_mb_before_aligner",
        "gpu_used_mb_after_aligner",
        "whisper_reason_counts",
        "whisper_selected_by_reason",
        "whisper_rejected_by_reason",
        "whisper_benefit_by_reason",
        "torch_allocated_mb_after_qwen",
        "torch_reserved_mb_after_qwen",
        "torch_allocated_mb_after_cleanup",
        "torch_reserved_mb_after_cleanup",
        "idle_python_cuda_context_mb",
        "qwen_cleanup_excess_gpu_mb",
        "qwen_worker_process_exited",
